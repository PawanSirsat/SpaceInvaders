...
window.onload = function () {
  ...
  document.getElementById('fireButton').addEventListener('mousedown', shoot)
  document
    .getElementById('leftButton')
    .addEventListener('mousedown', () => moveShip('ArrowLeft'))
  document
    .getElementById('rightButton')
    .addEventListener('mousedown', () => moveShip('ArrowRight'))
}
...
function moveShip(e) {
  ...
  if (
    (e == 'ArrowLeft' && ship.x - shipVelocityX >= 0) ||
    (e.code == 'ArrowLeft' && ship.x - shipVelocityX >= 0)
  ) {
    ship.x -= shipVelocityX //move left one tile
  } else if (
    (e == 'ArrowRight' && ship.x + shipVelocityX + ship.width <= board.width) ||
    (e.code == 'ArrowRight' &&
